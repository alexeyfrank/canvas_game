...
game.handlers.update_player = (function update_player(state,id,data){var player_8414 = cljs.core.get_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"players","players",520336676),id], null));player_8414.update(data);
return state;
});
