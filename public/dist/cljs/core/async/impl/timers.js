...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12454 = 0;while(true){
...
{var i_12461 = (self__.level + 1);while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12463 = 0;while(true){
if((i_12463 <= self__.level))
{var links_12464 = (update[i_12463]).forward;if(((links_12464[i_12463]) === x__$1))
