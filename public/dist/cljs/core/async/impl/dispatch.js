...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12081 = 0;while(true){
var m_12082 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12082 == null))
{} else
{m_12082.call(null);
if((count_12081 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12083 = (count_12081 + 1);
count_12081 = G__12083;
continue;
}
} else
{}
