...
{var pred__12857 = cljs.core._EQ_;var expr__12858 = limit;if(cljs.core.truth_(pred__12857.call(null,1,expr__12858)))
...
{var ch = s.charAt(index);var temp__4090__auto___12864 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12864))
{var replacement_12865 = temp__4090__auto___12864;buffer.append([cljs.core.str(replacement_12865)].join(''));
} else
{buffer.append(ch);
}
{
