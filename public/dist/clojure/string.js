...
{var pred__12700 = cljs.core._EQ_;var expr__12701 = limit;if(cljs.core.truth_(pred__12700.call(null,1,expr__12701)))
...
{var ch = s.charAt(index);var temp__4090__auto___12707 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12707))
{var replacement_12708 = temp__4090__auto___12707;buffer.append([cljs.core.str(replacement_12708)].join(''));
} else
{buffer.append(ch);
}
{
