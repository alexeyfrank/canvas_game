...
{{
var G__13153 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13153;
continue;
}
} else
...
{var pred__13157 = cljs.core._EQ_;var expr__13158 = limit;if(cljs.core.truth_(pred__13157.call(null,1,expr__13158)))
...
var G__13160 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13161 = (limit__$1 - 1);
var G__13162 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13160;
limit__$1 = G__13161;
parts = G__13162;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13164 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13164))
{var replacement_13165 = temp__4090__auto___13164;buffer.append([cljs.core.str(replacement_13165)].join(''));
} else
{buffer.append(ch);
}
{
var G__13166 = (index + 1);
index = G__13166;
continue;
}
}
