...
{{
var G__12842 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12842;
continue;
}
} else
...
{var pred__12846 = cljs.core._EQ_;var expr__12847 = limit;if(cljs.core.truth_(pred__12846.call(null,1,expr__12847)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12846.call(null,2,expr__12847)))
...
var G__12849 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12850 = (limit__$1 - 1);
var G__12851 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12849;
limit__$1 = G__12850;
parts = G__12851;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12853 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12853))
{var replacement_12854 = temp__4090__auto___12853;buffer.append([cljs.core.str(replacement_12854)].join(''));
} else
{buffer.append(ch);
}
{
var G__12855 = (index + 1);
index = G__12855;
continue;
}
}
