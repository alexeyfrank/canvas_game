...
var render_component_to_string__1 = (function (component){var res = cljs.core.atom.call(null,null);render_component_to_string.call(null,component,(function (p1__12556_SHARP_){return cljs.core.reset_BANG_.call(null,res,p1__12556_SHARP_);
}));
...
var G__12557__delegate = function (x,rest){return cljs.core.apply.call(null,cloact.ratom.atom,x,rest);
};
...
;
var p1_12560 = cloact.core.partial.call(null,cljs.core.vector,1,2);if(cljs.core._EQ_.call(null,p1_12560.call(null,3),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [1,2,3], null)))
{} else
